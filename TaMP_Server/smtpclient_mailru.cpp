 ...
 * @brief Реализация SMTP-клиента для отправки писем через Mail.ru.
 */
...
/**
 * @brief Читает значение из файла email.txt по ключу.
 * @param key Ключ (email или key).
 * @return Значение из файла или пустая строка.
 */
...
/**
 * @brief Возвращает email отправителя.
 */
...
/**
 * @brief Возвращает пароль (ключ) отправителя.
 */
...
/**
 * @brief Отправляет email для сброса пароля.
 */
